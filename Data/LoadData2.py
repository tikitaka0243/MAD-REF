...
# argo_concat(data_path='Argo/RawFiles', 
#             save_path='Argo/raw_argo_data.csv')

# # Select relevant variables, filter the data and standardize them
# argo_filter(data_path='Argo/raw_argo_data.csv', 
#             save_path='Argo/argo_data_filtered.npy', 
#             min_r=-2000, max_r=0, 
...
argo_split(data_path='Argo/argo_data_filtered.npy', 
           save_path='Argo', 
           ratio=[8, 1, 1])
...
# currents_convert_and_filter(data_path='Currents/RawFiles', 
#                             save_path='Currents/RawFiles', 
#                             min_r=-2000, max_r=0, 
#                             min_theta=-10, max_theta=10, 
#                             min_phi=-140, max_phi=-120, 
#                             min_t='2021-01-01T00:00:00Z', max_t='2021-07-01T00:00:00Z')
...
# currents_merge_and_split(data_path='Currents/RawFiles',
#                          save_path='Currents', 
#                          ratio=[8, 1, 1]) 